...
execute if score @e[type=armor_stand, name="StationCounter", distance=..1, limit=1] stationCounter = @e[type=armor_stand, name="HackSuccessCounter", distance=..1, limit=1] stationCounter unless entity @e[type=armor_stand, name="QuickTime", distance=..1] run summon armor_stand ~ ~ ~ {CustomName:'"QuickTime"'}
