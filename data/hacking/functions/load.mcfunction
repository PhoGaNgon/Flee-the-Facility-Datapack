...
#execute positioned ~ ~3 ~ if entity @p[distance=..4.5] if entity @e[type=armor_stand, name="HackSuccessCounter", distance=..1] as @e[type=minecraft:armor_stand, name="HackSuccessCounter", distance=..1] run function hacking:displayprogress
