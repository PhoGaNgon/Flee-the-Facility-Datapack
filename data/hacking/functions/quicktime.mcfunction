...
execute as @e[type=armor_stand, name="QuickTimer", scores={stationCounter=3..}, distance=..1, limit=1] run playsound minecraft:block.note_block.chime master @a[distance=..4, team=Hiders] ~ ~ ~ 1 .75
...
execute if score @s stationCounter matches 47 run kill @e[type=armor_stand, name="QuickTimer"]
execute if score @s stationCounter matches 47 run kill @s

title @a[distance=..4] times 0 10 0
execute if entity @e[type=armor_stand, name="HackSuccessCounter", distance=..1, scores={stationCounter=15}] run title @a[distance=..4] title [{"text":"____","color":"red"},{"text":"_","color":"green"},{"text":"_","color":"red"}]
execute if entity @e[type=armor_stand, name="HackSuccessCounter", distance=..1, scores={stationCounter=30}] run title @a[distance=..4] title [{"text":"__","color":"red"},{"text":"_","color":"green"},{"text":"___","color":"red"}]
execute if entity @e[type=armor_stand, name="HackSuccessCounter", distance=..1, scores={stationCounter=45}] run title @a[distance=..4] title [{"text":"___","color":"red"},{"text":"_","color":"green"},{"text":"__","color":"red"}]
execute if entity @e[type=armor_stand, name="HackSuccessCounter", distance=..1, scores={stationCounter=60}] run title @a[distance=..4] title [{"text":"_","color":"red"},{"text":"_","color":"green"},{"text":"____","color":"red"}]
execute if entity @e[type=armor_stand, name="HackSuccessCounter", distance=..1, scores={stationCounter=75}] run title @a[distance=..4] title [{"text":"__","color":"red"},{"text":"_","color":"green"},{"text":"___","color":"red"}]
execute if entity @e[type=armor_stand, name="HackSuccessCounter", distance=..1, scores={stationCounter=90}] run title @a[distance=..4] title [{"text":"_____","color":"red"},{"text":"_","color":"green"},{"text":"","color":"red"}]
