...
execute as Baconking26 if entity @s[tag=leash] at @s run tp @e[type=allay, name="Baconking26"] @s
execute as JBEmeraldMC if entity @s[tag=leash] at @s run tp @e[type=allay, name="JBEmeraldMC"] @s
execute as INSERTNAME1 if entity @s[tag=leash] at @s run tp @e[type=allay, name="INSERTNAME1"] @s
execute as INSERTNAME2 if entity @s[tag=leash] at @s run tp @e[type=allay, name="INSERTNAME2"] @s
